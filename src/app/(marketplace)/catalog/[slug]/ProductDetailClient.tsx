                ...
                <div className="space-y-8 py-6">
                    ...
                    {user ? (
                        <div className="flex flex-col gap-3">
                            ...
                            {/* Compra Protegida Box — solo marketplace (Stripe). Single-vendor stores no la usan. */}
                            {!isSingleVendor && (
                                <div className="flex items-start gap-3 p-4 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800/50 rounded-2xl mt-2">
                                    ...
                                    <div>
                                        <p className="text-xs font-black text-green-700 dark:text-green-400 uppercase tracking-wider mb-0.5">Compra Protegida</p>
                                        <p className="text-[11px] font-medium text-green-600/80 dark:text-green-300/80 leading-snug">Paga con Tarjeta y protegeremos tu dinero hasta que recibas tu pedido.</p>
                                    </div>
                                </div>
                            )}
                        </div>
