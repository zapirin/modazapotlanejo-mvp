            ...
            <div className="w-full max-w-2xl space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            { name: 'Básico', price: 'Gratis', color: 'from-gray-600 to-gray-700', badge: '', locations: 1, cashiers: 1, products: 50, highlight: false },
                            { name: 'Estándar', price: '$299/mes', color: 'from-blue-600 to-indigo-700', badge: '⭐ Popular', locations: 2, cashiers: 3, products: 200, highlight: true },
                            { name: 'Pro', price: '$599/mes', color: 'from-violet-600 to-purple-700', badge: '🚀 Recomendado', locations: 5, cashiers: 10, products: 'Ilimitados', highlight: false },
                            { name: 'Empresarial', price: '$999/mes', color: 'from-amber-600 to-orange-700', badge: '🏆 Más Completo', locations: 20, cashiers: 50, products: 'Ilimitados', highlight: false },
                        ].map((plan) => (
